...
<header>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    <div class="container-fluid">
      <a class="navbar-brand" href="#">Coffee Database Show</a>
      ...
      <div class="collapse navbar-collapse" id="navbarCollapse">
        <ul class="navbar-nav me-auto mb-2 mb-md-0">
          <li class="nav-item">
            <a class="nav-link" aria-current="page" href="#">Coffee Bean</a>
          </li>
          <li class="nav-item">
            <a class="nav-link active" href="#">Coffee Region</a>
          </li>
          <li class="nav-item">
            <a class="nav-link " aria-disabled="true">Coffee Product</a>
          </li>
        </ul>
